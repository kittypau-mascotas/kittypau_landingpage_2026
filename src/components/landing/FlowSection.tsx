...
export function FlowSection() {
  return (
    <section className="py-4">
      ...
      <p className="text-center text-gray-500 mb-10 max-w-xl mx-auto text-sm">Así transforma KittyPau los datos de tu mascota en información útil para su salud.</p>
