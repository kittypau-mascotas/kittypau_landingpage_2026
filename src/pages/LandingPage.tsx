...
import {
  ...
  Plug, QrCode, MonitorDot, Brain, Cpu, Smartphone, TrendingUp, Menu, ChevronRight,
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-white font-varela-round">
      ...
      <nav className="bg-white/70 backdrop-blur-md sticky top-0 z-50 border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <Button
            asChild
            className="hidden md:flex bg-primary text-primary-foreground hover:opacity-90 rounded-2xl px-5 py-2 shadow-lg font-bold text-sm flex-shrink-0 ring-2 ring-primary/30 ring-offset-1"
          >
          ...
          <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
            ...
            <SheetContent side="right" className="w-64 pt-12">
              <nav className="flex flex-col gap-5">
                ...
                <Button
                  asChild
                  className="bg-primary text-primary-foreground hover:opacity-90 rounded-2xl font-bold mt-2"
                >
                  <a href={LOGIN_URL} target="_blank" rel="noopener noreferrer" onClick={() => setMobileMenuOpen(false)}>
                    🐾 Prueba gratis
                  </a>
                </Button>
              </nav>
      ...
      <div className="max-w-5xl mx-auto px-4">
        <main className="space-y-16 pb-8 mt-16">
          ...
          <section id="caracteristicas" className="scroll-mt-20 py-8">
            <h2 className="text-3xl sm:text-4xl text-center text-primary mb-3">Características</h2>
          ...
          <section className="py-4">
            <h2 className="text-2xl sm:text-3xl text-center text-primary mb-2">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-0">
              ...
              <ChevronRight className="text-gray-300 h-7 w-7 mx-1 rotate-90 md:rotate-0 flex-shrink-0" />
              <div className="flex flex-col items-center text-center bg-white rounded-2xl shadow-md p-5 w-40">
          ...
          <section id="dashboard-preview" className="py-8 bg-gray-50 rounded-2xl shadow-md px-4">
            <h2 className="text-2xl sm:text-3xl text-center text-primary mb-3">
          ...
          <section id="como-funciona" className="scroll-mt-20 py-8">
            <h2 className="text-3xl sm:text-4xl text-center text-primary mb-12">Cómo funciona</h2>
          ...
          <section id="planes" className="scroll-mt-20 py-8 bg-gray-50 rounded-2xl shadow-md">
            <h2 className="text-3xl sm:text-4xl text-center text-primary mb-12">Planes</h2>
          ...
          <Card className="bg-white">
            <div className="flex flex-col items-center gap-6 p-4 sm:p-6">
              <div className="text-center">
                <h2 className="text-2xl sm:text-3xl text-gray-800">Únete al Programa Early Adopter</h2>
          ...
          <section id="quienes-somos" className="scroll-mt-20 py-8">
            <h2 className="text-3xl sm:text-4xl text-center text-primary mb-3">Quiénes somos</h2>
        ...
        <footer className="py-8 border-t border-gray-200 bg-gray-50 rounded-t-2xl">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4 mb-2">
              <a href="mailto:kittypau.mascotas@gmail.com" className="text-gray-400 hover:text-primary transition-colors text-sm">Soporte</a>
            </div>
